...
# It is a shortcut for "build-docs.sh --no-javadoc", see that script for the details.
...
#       > build-asciidocs.sh master 5.0
#

exec "$( dirname "${BASH_SOURCE[0]}" )/build-docs.sh" --no-javadoc "$@"
